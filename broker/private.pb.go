...
func (FundingType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (PrivateOrder_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*PrivateOrder) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*PrivateOrder_PriceParam) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
type PrivateTrade struct {
	...
	IdString     string  `protobuf:"bytes,7,opt,name=idString" json:"idString,omitempty"`
...
func (*PrivateTrade) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (m *PrivateTrade) GetIdString() string {
	if m != nil {
		return m.IdString
	}
	return ""
...
func (*PrivatePosition) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*Balance) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*Balances) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func init() { proto.RegisterFile("broker/private.proto", fileDescriptor1) }
...
var fileDescriptor1 = []byte{
	...
	,
}
